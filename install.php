...
$sql->setQuery("CREATE TABLE IF NOT EXISTS ". rex::getTablePrefix() ."d2u_machinery_machines (
	...
	pic_usage text collate utf8_general_ci default NULL,
	...
	feature_ids varchar(255) collate utf8_general_ci default NULL,
	service_ids varchar(255) collate utf8_general_ci default NULL,
	accessory_ids varchar(255) collate utf8_general_ci default NULL,
	product_number varchar(255) collate utf8_general_ci default NULL,
	business_ids varchar(255) collate utf8_general_ci default NULL,
	...
	certificate_ids varchar(255) collate utf8_general_ci default NULL,
	construction_id int(10) default NULL,
	agitator_type_id int(10) default NULL,
	process_ids varchar(255) collate utf8_general_ci default NULL,
	application_ids varchar(255) collate utf8_general_ci default NULL,
	material_class_ids varchar(255) collate utf8_general_ci default NULL,
	tool_ids varchar(255) collate utf8_general_ci default NULL,
	...
	weight_empty varchar(255) collate utf8_general_ci default NULL,
...
$sql->setQuery("CREATE TABLE IF NOT EXISTS ". rex::getTablePrefix() ."d2u_machinery_machines_lang (
	...
	description_technical text collate utf8_general_ci default NULL,
	pdfs varchar(255) collate utf8_general_ci default NULL,
	connection_infos varchar(255) collate utf8_general_ci default NULL,
