...
$sql->setQuery("CREATE TABLE IF NOT EXISTS ". \rex::getTablePrefix() ."d2u_machinery_machines_lang (
	...
	leaflet varchar(255) collate utf8mb4_unicode_ci default NULL,
...
if (!$this->hasConfig()) { /** @phpstan-ignore-line */
	...
	$this->setConfig('default_category_sort', 'name'); /** @phpstan-ignore-line */
	$this->setConfig('default_machine_sort', 'name'); /** @phpstan-ignore-line */
	$this->setConfig('show_categories_usage_area', 'hide'); /** @phpstan-ignore-line */
	$this->setConfig('show_teaser', 'hide'); /** @phpstan-ignore-line */
	$this->setConfig('show_techdata', 'show'); /** @phpstan-ignore-line */
}