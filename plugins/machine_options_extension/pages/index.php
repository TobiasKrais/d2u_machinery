						...
						<div class="panel-body-wrapper slide">
							<?php
                                if ($rex_clang->getId() !== (int) rex_config::get('d2u_helper', 'default_lang')) {
                                    ...
                                    \TobiasKrais\D2UHelper\BackendHelper::form_select('d2u_helper_translation', 'form[lang]['. $rex_clang->getId() .'][translation_needs_update]', $options_translations, [$option->translation_needs_update], 1, false, $readonly_lang);
                                } else {
							...
							<div id="details_clang_<?= $rex_clang->getId() ?>">
								<?php
                                    \TobiasKrais\D2UHelper\BackendHelper::form_input('d2u_helper_name', 'form[lang]['. $rex_clang->getId() .'][name]', $option->name, $required, $readonly_lang, 'text');
                                    \TobiasKrais\D2UHelper\BackendHelper::form_textarea('d2u_helper_description', 'form[lang]['. $rex_clang->getId() .'][description]', $option->description, 10, false, $readonly_lang, true);
                                ?>
							</div>
						</div>
					</fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
                            ...
                            if (\rex_addon::get('d2u_videos')->isAvailable()) {
                                ...
                                \TobiasKrais\D2UHelper\BackendHelper::form_select('d2u_machinery_video', 'form[video_id]', $options_video, false !== $option->video ? [$option->video instanceof TobiasKrais\D2UVideos\Video ? $option->video->video_id : 0] : [], 1, false, $readonly);
                            }
                        ?>
					</div>
				</fieldset>
