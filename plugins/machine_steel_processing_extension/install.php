...
$sql->setQuery("CREATE TABLE IF NOT EXISTS ". rex::getTablePrefix() ."d2u_machinery_steel_supply (
	...
	videomanager_id int(10) default NULL,
...
if($sql->getRows() == 0) {
	$sql->setQuery("ALTER TABLE ". rex::getTablePrefix() ."d2u_machinery_machines "
		...
		. "ADD tool_ids VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER material_ids, "
		. "ADD automation_supply_single_stroke VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER tool_ids, "
		. "ADD automation_supply_multi_stroke VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER automation_supply_single_stroke, "
		. "ADD automation_feedrate VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER automation_supply_multi_stroke, "
		...
		. "ADD workspace_profile VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER workspace_plate, "
		. "ADD workspace_angle_steel VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER workspace_profile, "
		. "ADD workspace_round VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER workspace_angle_steel, "
		. "ADD workspace_min VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER workspace_round, "
		. "ADD sheet_width VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER workspace_min, "
		. "ADD sheet_length VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER sheet_width, "
		. "ADD sheet_thickness VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER sheet_length, "
		. "ADD tool_changer_locations VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER sheet_thickness, "
		. "ADD drilling_unit_vertical VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER tool_changer_locations, "
		. "ADD drilling_unit_horizontal VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER drilling_unit_vertical, "
		. "ADD drilling_diameter VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER drilling_unit_horizontal, "
		. "ADD drilling_tools_axis VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER drilling_diameter, "
		. "ADD drilling_axis_drive_power VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER drilling_tools_axis, "
		. "ADD drilling_rpm_speed VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER drilling_axis_drive_power, "
		. "ADD saw_blade VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER drilling_rpm_speed, "
		. "ADD saw_band VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER saw_blade, "
		. "ADD saw_band_tilt VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER saw_band, "
		. "ADD saw_cutting_speed VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER saw_band_tilt, "
		...
		. "ADD carrier_height VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER carrier_width, "
		. "ADD carrier_weight int(10) DEFAULT NULL AFTER carrier_height, "
		. "ADD flange_thickness VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER carrier_weight, "
		. "ADD web_thickness VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER flange_thickness, "
		. "ADD component_length VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER web_thickness, "
		. "ADD component_weight int(10) DEFAULT NULL AFTER component_length, "
		. "ADD welding_process_ids VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER component_weight, "
