...
\rex_sql_table::get(
    ...
    ->ensureColumn(new \rex_sql_column('automation_supply_single_stroke', 'VARCHAR(255)'))
    ->ensureColumn(new \rex_sql_column('automation_supply_multi_stroke', 'VARCHAR(255)'))
    ->ensureColumn(new \rex_sql_column('automation_feedrate', 'VARCHAR(255)'))
    ->ensureColumn(new \rex_sql_column('automation_rush_leader_flyback', 'VARCHAR(255)'))
    ...
    ->ensureColumn(new \rex_sql_column('drilling_unit_vertical', 'VARCHAR(255)'))
    ->ensureColumn(new \rex_sql_column('drilling_unit_horizontal', 'VARCHAR(255)'))
