...
if (1 === (int) filter_input(INPUT_POST, 'btn_save') || 1 === (int) filter_input(INPUT_POST, 'btn_apply')) {
    ...
    if (1 === (int) filter_input(INPUT_POST, 'btn_apply', FILTER_VALIDATE_INT) && false !== $welding) {
        header('Location: '. rex_url::currentBackendPage(['entry_id' => $welding->welding_id, 'func' => 'edit', 'message' => $message], false));
    } else {
					...
					<fieldset>
						...
						<div class="panel-body-wrapper slide">
							...
							<div id="details_clang_<?= $rex_clang->getId() ?>">
								<?php
                                    d2u_addon_backend_helper::form_input('d2u_helper_name', 'form[lang]['. $rex_clang->getId() .'][name]', $welding->name, $required, $readonly_lang, 'text');
                                ?>
							</div>
						</div>
					</fieldset>
