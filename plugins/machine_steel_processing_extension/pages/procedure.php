				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
							...
							$procedure = new Procedure($entry_id, intval(rex_config::get("d2u_helper", "default_lang")));
							$readonly = true;
...
if ($func === '') {
	$query = 'SELECT procedures.procedure_id, internal_name '
		...
		. 'LEFT JOIN '. \rex::getTablePrefix() .'d2u_machinery_steel_procedure_lang AS lang '
			. 'ON procedures.procedure_id = lang.procedure_id AND lang.clang_id = '. intval(rex_config::get("d2u_helper", "default_lang")) .' '
		. 'ORDER BY name ASC';
