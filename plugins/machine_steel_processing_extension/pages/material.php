...
// Delete
	...
	$material = new Material($material_id, intval(rex_config::get("d2u_helper", "default_lang")));
...
if ($func == '') {
	$query = 'SELECT materials.material_id, internal_name '
		...
		. 'LEFT JOIN '. \rex::getTablePrefix() .'d2u_machinery_steel_material_lang AS lang '
			. 'ON materials.material_id = lang.material_id AND lang.clang_id = '. intval(rex_config::get("d2u_helper", "default_lang")) .' '
		. 'ORDER BY name ASC';
