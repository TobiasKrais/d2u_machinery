				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
							...
							$profile = new Profile($entry_id, intval(rex_config::get("d2u_helper", "default_lang")));
							$readonly = TRUE;
...
if ($func === '') {
	$query = 'SELECT profiles.profile_id, internal_name '
		...
		. 'LEFT JOIN '. \rex::getTablePrefix() .'d2u_machinery_steel_profile_lang AS lang '
			. 'ON profiles.profile_id = lang.profile_id AND lang.clang_id = '. intval(rex_config::get("d2u_helper", "default_lang")) .' '
		. 'ORDER BY name ASC';
