...
?>
	<form action="<?php print rex_url::currentBackendPage(); ?>" method="post">
		<div class="panel panel-edit">
			<header class="panel-heading"><div class="panel-title"><?php print rex_i18n::msg('d2u_machinery_export'); ?></div></header>
			<div class="panel-body">
				<input type="hidden" name="form[provider_id]" value="<?php echo $entry_id; ?>">
				<fieldset>
					<legend><?php echo rex_i18n::msg('d2u_machinery_export_basic_settings'); ?></legend>
...
if ($func == '') {
    ...
    $list->setColumnLabel('name', rex_i18n::msg('d2u_machinery_name'));
