...
class d2u_machinery_frontend_helper {
	...
	public static function getAlternateURLs() {
		...
		if(filter_input(INPUT_GET, 'machine_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0 || $url_namespace === "machine_id") {
			...
			if(rex_plugin::get("d2u_machinery", "used_machines")->isAvailable() && filter_input(INPUT_GET, 'used_rent_category_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0) {
				...
				$category_id = intval(filter_input(INPUT_GET, 'used_rent_category_id', FILTER_VALIDATE_INT));
				$offer_type = 'rent';
			}
			elseif(rex_plugin::get("d2u_machinery", "used_machines")->isAvailable() && filter_input(INPUT_GET, 'used_sale_category_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0) {
				...
				$category_id = intval(filter_input(INPUT_GET, 'used_sale_category_id', FILTER_VALIDATE_INT));
				$offer_type = 'sale';
			}
			if(rex_addon::get("url")->isAvailable() && $url_id > 0) {
				$category_id = $url_id;
	...
	public static function getBreadcrumbs() {
		...
		if(filter_input(INPUT_GET, 'used_rent_machine_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0 || filter_input(INPUT_GET, 'used_sale_machine_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0 || ($url_namespace === "used_rent_machine_id" || $url_namespace === "used_sale_machine_id")) {
			$used_machine_id = intval(filter_input(INPUT_GET, 'used_rent_machine_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0 ? filter_input(INPUT_GET, 'used_rent_machine_id', FILTER_VALIDATE_INT) : filter_input(INPUT_GET, 'used_sale_machine_id', FILTER_VALIDATE_INT));
			if(\rex_addon::get("url")->isAvailable() && $url_id > 0) {
				$used_machine_id = $url_id;
			}
		...
		if(rex_plugin::get("d2u_machinery", "production_lines")->isAvailable() && (filter_input(INPUT_GET, 'production_line_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0 || $url_namespace === "production_line_id")) {
			$production_line_id = intval(filter_input(INPUT_GET, 'production_line_id', FILTER_VALIDATE_INT));
			if(\rex_addon::get("url")->isAvailable() && $url_id > 0) {
	...
	public static function getD2UMachineryResponsiveMultiLevelSubmenu():void {
		if(strval(rex_config::get('d2u_machinery', 'show_categories_navi', 'hide')) === 'show') {
			// Get current IDs
			...
			if(filter_input(INPUT_GET, 'machine_id', FILTER_VALIDATE_INT, ['options' => ['default'=> 0]]) > 0 || $url_namespace === "machine_id") {
				$current_machine_id = intval(filter_input(INPUT_GET, 'machine_id', FILTER_VALIDATE_INT));
				if(\rex_addon::get("url")->isAvailable() && $url_id > 0) {
