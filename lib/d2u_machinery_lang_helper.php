...
class d2u_machinery_lang_helper extends \D2U_Helper\ALangHelper {
	...
	protected $replacements_russian = [
		...
		'd2u_machinery_back_machine_list' => 'Вернуться к списку машин',
		'd2u_machinery_consultation_heading' => 'Давайте советую вам',
		'd2u_machinery_consultation_hint' => 'Мы предлагаем оптимальное решение для ваших нужд.<br><b>Свяжитесь с нами.</b>',
		'd2u_machinery_consultation_link_machine' => 'К запросу машины',
		...
		'd2u_machinery_no_machines' => 'Машины не найдены',
