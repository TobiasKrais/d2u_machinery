				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
						    ...
						    BackendHelper::form_input('d2u_helper_name', 'form[name]', $contact->name, true, $readonly);
						    BackendHelper::form_input('d2u_machinery_contacts_email', 'form[email]', $contact->email, true, $readonly, 'email');
						    BackendHelper::form_input('d2u_machinery_contacts_phone', 'form[phone]', $contact->phone, false, $readonly);
...
if ('' === $func) {
	...
	if (rex::getUser() instanceof rex_user && (rex::getUser()->isAdmin() || rex::getUser()->hasPerm('d2u_machinery[edit_data]'))) {
		...
		$list->setColumnParams(rex_i18n::msg('delete_module'), ['func' => 'delete', 'entry_id' => '###contact_id###'] + $csrfToken->getUrlParams());
