...
if (!$invalidCsrf && (1 === (int) filter_input(INPUT_POST, 'btn_save') || 1 === (int) filter_input(INPUT_POST, 'btn_apply'))) {
	...
	foreach (rex_clang::getAll() as $rex_clang) {
		...
		if ('clone' === $func) {
			...
			$machine->translation_needs_update = 'no';
				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
							...
							BackendHelper::form_select('d2u_helper_category', 'form[category_id]', $options, $machine->category instanceof Category ? [$machine->category->category_id] : [], 1, false, $readonly);
							if (Extension::isActive('contacts')) {
								...
								BackendHelper::form_select('d2u_machinery_contacts_contact', 'form[contact_id]', $options_contacts, [$machine->contact instanceof \TobiasKrais\D2UMachinery\Contact ? (string) $machine->contact->contact_id : ''], 1, false, $readonly);
							}
							...
							if (\rex_addon::get('d2u_references')->isAvailable()) {
								...
								BackendHelper::form_select('d2u_references', 'form[reference_ids][]', $options_references, $machine->reference_ids, 10, true, $readonly);
							}
							if (\rex_addon::get('d2u_videos')->isAvailable()) {
								$options = [];
							...
							BackendHelper::form_input('d2u_machinery_machine_width', 'form[width]', $machine->width, false, $readonly, 'number');
							BackendHelper::form_input('d2u_machinery_machine_height', 'form[height]', $machine->height, false, $readonly, 'number');
							BackendHelper::form_input('d2u_machinery_machine_depth', 'form[depth]', $machine->depth, false, $readonly, 'number');
							BackendHelper::form_input('d2u_machinery_machine_weight', 'form[weight]', $machine->weight, false, $readonly, 'text');
							BackendHelper::form_input('d2u_machinery_machine_voltage_v', 'form[operating_voltage_v]', $machine->operating_voltage_v, false, $readonly, 'text');
							BackendHelper::form_input('d2u_machinery_machine_voltage_hz', 'form[operating_voltage_hz]', $machine->operating_voltage_hz, false, $readonly, 'text');
							BackendHelper::form_input('d2u_machinery_machine_voltage_a', 'form[operating_voltage_a]', $machine->operating_voltage_a, false, $readonly, 'text');
						?>
					</div>
				</fieldset>
				<?php
					if (Extension::isActive('equipment')) {
						...
						BackendHelper::form_select('d2u_machinery_equipments', 'form[equipment_ids][]', $options_equipments, $machine->equipment_ids, 10, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('industry_sectors')) {
						...
						BackendHelper::form_select('d2u_machinery_industry_sectors', 'form[industry_sector_ids][]', $options_industry_sectors, $machine->industry_sector_ids, 10, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('machine_agitator_extension')) {
						...
						BackendHelper::form_select('d2u_machinery_agitator_type', 'form[agitator_type_id]', $options_agitator_types, [$machine->agitator_type_id], 1, false, $readonly);
						BackendHelper::form_input('d2u_machinery_agitators_viscosity', 'form[viscosity]', $machine->viscosity, false, $readonly, 'number');
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('machine_certificates_extension')) {
						...
						BackendHelper::form_select('d2u_machinery_certificates', 'form[certificate_ids][]', $options_certificates, $machine->certificate_ids, 10, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('machine_construction_equipment_extension')) {
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_construction_equipment_airless_hose_connection', 'form[airless_hose_connection]', $machine->airless_hose_connection, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_airless_hose_diameter', 'form[airless_hose_diameter]', $machine->airless_hose_diameter, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_airless_hose_length', 'form[airless_hose_length]', $machine->airless_hose_length, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_airless_nozzle_size', 'form[airless_nozzle_size]', $machine->airless_nozzle_size, false, $readonly, 'text');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_construction_equipment_container_capacity', 'form[container_capacity]', $machine->container_capacity, false, $readonly, 'text');
						...
						BackendHelper::form_select('d2u_machinery_construction_equipment_container_capacity_unit', 'form[container_capacity_unit]', $options_container_unit, [$machine->container_capacity_unit], 1, false, $readonly);
						BackendHelper::form_input('d2u_machinery_construction_equipment_container_mixing_performance', 'form[container_mixing_performance]', $machine->container_mixing_performance, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_container_waterconnect_pressure', 'form[container_waterconnect_pressure]', $machine->container_waterconnect_pressure, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_container_waterconnect_diameter', 'form[container_waterconnect_diameter]', $machine->container_waterconnect_diameter, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_container_weight_empty', 'form[container_weight_empty]', $machine->container_weight_empty, false, $readonly, 'number');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_construction_equipment_cutters_cutting_depth', 'form[cutters_cutting_depth]', $machine->cutters_cutting_depth, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_cutters_cutting_length', 'form[cutters_cutting_length]', $machine->cutters_cutting_length, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_cutters_rod_length', 'form[cutters_rod_length]', $machine->cutters_rod_length, false, $readonly, 'text');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_construction_equipment_floor_beam_power_on_concrete', 'form[floor_beam_power_on_concrete]', $machine->floor_beam_power_on_concrete, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_floor_dust_extraction_connection', 'form[floor_dust_extraction_connection]', $machine->floor_dust_extraction_connection, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_floor_feedrate', 'form[floor_feedrate]', $machine->floor_feedrate, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_floor_filter_connection', 'form[floor_filter_connection]', $machine->floor_filter_connection, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_floor_rotations', 'form[floor_rotations]', $machine->floor_rotations, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_floor_working_pressure', 'form[floor_working_pressure]', $machine->floor_working_pressure, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_floor_working_width', 'form[floor_working_width]', $machine->floor_working_width, false, $readonly, 'number');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_construction_equipment_grinder_grinding_plate', 'form[grinder_grinding_plate]', $machine->grinder_grinding_plate, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_grinder_grinding_wheel', 'form[grinder_grinding_wheel]', $machine->grinder_grinding_wheel, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_grinder_rotational_frequency', 'form[grinder_rotational_frequency]', $machine->grinder_rotational_frequency, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_grinder_sanding', 'form[grinder_sanding]', $machine->grinder_sanding, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_grinder_vacuum_connection', 'form[grinder_vacuum_connection]', $machine->grinder_vacuum_connection, false, $readonly, 'number');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_construction_equipment_operating_pressure', 'form[operating_pressure]', $machine->operating_pressure, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_pump_filling', 'form[pump_filling]', $machine->pump_filling, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_pump_grain_size', 'form[pump_grain_size]', $machine->pump_grain_size, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_pump_material_container', 'form[pump_material_container]', $machine->pump_material_container, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_pump_flow_volume', 'form[pump_flow_volume]', $machine->pump_flow_volume, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_construction_equipment_pump_conveying_distance', 'form[pump_conveying_distance]', $machine->pump_conveying_distance, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_construction_equipment_pump_pressure_height', 'form[pump_pressure_height]', $machine->pump_pressure_height, false, $readonly, 'number');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_construction_equipment_waste_water_capacity', 'form[waste_water_capacity]', $machine->waste_water_capacity, false, $readonly, 'number');
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('service_options')) {
						...
						BackendHelper::form_select('d2u_machinery_service_options', 'form[service_option_ids][]', $options_services, $machine->service_option_ids, 10, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('machine_features_extension')) {
						...
						BackendHelper::form_select('d2u_machinery_features', 'form[feature_ids][]', $options_features, $machine->feature_ids, 10, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('machine_options_extension')) {
						...
						BackendHelper::form_select('d2u_machinery_options', 'form[option_ids][]', $options_options, $machine->option_ids, 10, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('machine_steel_processing_extension')) {
						...
						BackendHelper::form_select('d2u_machinery_steel_processes', 'form[process_ids][]', $options_processes, array_keys($machine->processes), 4, true, $readonly);
						$options_procedures = [];
						...
						BackendHelper::form_select('d2u_machinery_steel_procedures', 'form[procedure_ids][]', $options_procedures, array_keys($machine->procedures), 4, true, $readonly);
						$options_materials = [];
						...
						BackendHelper::form_select('d2u_machinery_steel_material_class', 'form[material_ids][]', $options_materials, array_keys($machine->materials), 4, true, $readonly);
						$options_tools = [];
						foreach (Tool::getAll((int) rex_config::get('d2u_helper', 'default_lang')) as $tool) {
							$options_tools[$tool->tool_id] = $tool->name;
						}
						BackendHelper::form_select('d2u_machinery_steel_tools', 'form[tool_ids][]', $options_tools, array_keys($machine->tools), 4, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
						...
						BackendHelper::form_select('d2u_machinery_steel_automation_automationgrades', 'form[automation_automationgrade_ids][]', $options_automation, array_keys($machine->automation_automationgrades), 4, true, $readonly);
						echo '</div>';
						echo '</fieldset>';

						if (Extension::isActive('machine_steel_automation_extension')) {
							echo '<fieldset>';
							echo '<legend><small><i class="rex-icon fa-exchange"></i></small> '. rex_i18n::msg('d2u_machinery_supply_extension') .'</legend>';
							echo '<div class="panel-body-wrapper slide">';
							BackendHelper::form_input('d2u_machinery_steel_automation_supply_single_stroke', 'form[automation_supply_single_stroke]', $machine->automation_supply_single_stroke, false, $readonly, 'text');
							BackendHelper::form_input('d2u_machinery_steel_automation_supply_multi_stroke', 'form[automation_supply_multi_stroke]', $machine->automation_supply_multi_stroke, false, $readonly, 'text');
							BackendHelper::form_input('d2u_machinery_steel_automation_feedrate', 'form[automation_feedrate]', $machine->automation_feedrate, false, $readonly, 'text');
							BackendHelper::form_input('d2u_machinery_steel_automation_rush_leader_flyback', 'form[automation_rush_leader_flyback]', $machine->automation_rush_leader_flyback, false, $readonly, 'text');
							$options_supply = [];
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_steel_workspace', 'form[workspace]', $machine->workspace, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_workspace_min', 'form[workspace_min]', $machine->workspace_min, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_workspace_square', 'form[workspace_square]', $machine->workspace_square, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_workspace_flat', 'form[workspace_flat]', $machine->workspace_flat, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_workspace_plate', 'form[workspace_plate]', $machine->workspace_plate, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_workspace_profile', 'form[workspace_profile]', $machine->workspace_profile, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_workspace_angle_steel', 'form[workspace_angle_steel]', $machine->workspace_angle_steel, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_workspace_round', 'form[workspace_round]', $machine->workspace_round, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_sheet_width', 'form[sheet_width]', $machine->sheet_width, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_sheet_length', 'form[sheet_length]', $machine->sheet_length, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_sheet_thickness', 'form[sheet_thickness]', $machine->sheet_thickness, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_tool_changer_locations', 'form[tool_changer_locations]', $machine->tool_changer_locations, false, $readonly, 'text');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_steel_drilling_unit_vertical', 'form[drilling_unit_vertical]', $machine->drilling_unit_vertical, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_drilling_unit_horizontal', 'form[drilling_unit_horizontal]', $machine->drilling_unit_horizontal, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_drilling_unit_below', 'form[drilling_unit_below]', $machine->drilling_unit_below, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_steel_drilling_diameter', 'form[drilling_diameter]', $machine->drilling_diameter, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_drilling_tools_axis', 'form[drilling_tools_axis]', $machine->drilling_tools_axis, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_drilling_axis_drive_power', 'form[drilling_axis_drive_power]', $machine->drilling_axis_drive_power, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_drilling_rpm_speed', 'form[drilling_rpm_speed]', $machine->drilling_rpm_speed, false, $readonly, 'text');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_steel_saw_blade', 'form[saw_blade]', $machine->saw_blade, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_saw_band', 'form[saw_band]', $machine->saw_band, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_saw_band_tilt', 'form[saw_band_tilt]', $machine->saw_band_tilt, false, $readonly, 'text');
						if (Extension::isActive('machine_steel_automation_extension')) {
							BackendHelper::form_input('d2u_machinery_steel_automation_feedrate_sawblade', 'form[automation_feedrate_sawblade]', $machine->automation_feedrate_sawblade, false, $readonly, 'text');
						}
						BackendHelper::form_input('d2u_machinery_steel_saw_cutting_speed', 'form[saw_cutting_speed]', $machine->saw_cutting_speed, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_saw_miter', 'form[saw_miter]', $machine->saw_miter, false, $readonly, 'text');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_steel_punching_bevel_angle', 'form[bevel_angle]', $machine->bevel_angle, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_steel_punching_diameter', 'form[punching_diameter]', $machine->punching_diameter, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_punching_power', 'form[punching_power]', $machine->punching_power, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_steel_punching_tools', 'form[punching_tools]', $machine->punching_tools, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_punching_shaving_unit_angle_steel_single_cut', 'form[shaving_unit_angle_steel_single_cut]', $machine->shaving_unit_angle_steel_single_cut, false, $readonly, 'number');
						$options_profile = [];
						...
						BackendHelper::form_select('d2u_machinery_steel_punching_profiles', 'form[profile_ids][]', $options_profile, array_keys($machine->profiles), 4, true, $readonly);
						BackendHelper::form_input('d2u_machinery_steel_punching_carrier_width', 'form[carrier_width]', $machine->carrier_width, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_punching_carrier_height', 'form[carrier_height]', $machine->carrier_height, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_punching_carrier_weight', 'form[carrier_weight]', $machine->carrier_weight, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_steel_punching_flange_thickness', 'form[flange_thickness]', $machine->flange_thickness, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_punching_web_thickness', 'form[web_thickness]', $machine->web_thickness, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_punching_component_length', 'form[component_length]', $machine->component_length, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_punching_component_weight', 'form[component_weight]', $machine->component_weight, false, $readonly, 'number');
						$options_welding = [];
						...
						BackendHelper::form_select('d2u_machinery_steel_weldings', 'form[welding_process_ids][]', $options_welding, array_keys($machine->weldings), 4, true, $readonly);
						BackendHelper::form_input('d2u_machinery_steel_welding_thickness', 'form[welding_thickness]', $machine->welding_thickness, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_steel_welding_wire_thickness', 'form[welding_wire_thickness]', $machine->welding_wire_thickness, false, $readonly, 'text');
						echo '</div>';
						echo '</fieldset>';
						...
						echo '<div class="panel-body-wrapper slide">';
						BackendHelper::form_input('d2u_machinery_steel_beam_continuous_opening', 'form[beam_continuous_opening]', $machine->beam_continuous_opening, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_beam_turbines', 'form[beam_turbines]', $machine->beam_turbines, false, $readonly, 'number');
						BackendHelper::form_input('d2u_machinery_steel_beam_turbine_power', 'form[beam_turbine_power]', $machine->beam_turbine_power, false, $readonly, 'text');
						BackendHelper::form_input('d2u_machinery_steel_beam_color_guns', 'form[beam_color_guns]', $machine->beam_color_guns, false, $readonly, 'text');
						echo '</div>';
						echo '</fieldset>';
					}
					if (Extension::isActive('machine_usage_area_extension')) {
						...
						BackendHelper::form_select('d2u_machinery_usage_areas', 'form[usage_area_ids][]', $options_usage_areas, $machine->usage_area_ids, 10, true, $readonly);
						echo '</div>';
						echo '</fieldset>';
					}
						...
						<div class="panel-body-wrapper slide">
							<?php
								if ($rex_clang->getId() !== (int) rex_config::get('d2u_helper', 'default_lang')) {
									...
									BackendHelper::form_select('d2u_helper_translation', 'form[lang]['. $rex_clang->getId() .'][translation_needs_update]', $options_translations, [$machine_lang->translation_needs_update], 1, false, $readonly_lang);
								} else {
							...
							<div id="details_clang_<?= $rex_clang->getId() ?>">
								<?php
									...
									if (Extension::isActive('machine_construction_equipment_extension')) {
										BackendHelper::form_input('d2u_machinery_construction_equipment_container_connection_port', 'form[lang]['. $rex_clang->getId() .'][container_connection_port]', $machine_lang->container_connection_port, false, $readonly_lang, 'text');
										BackendHelper::form_input('d2u_machinery_construction_equipment_container_conveying_wave', 'form[lang]['. $rex_clang->getId() .'][container_conveying_wave]', $machine_lang->container_conveying_wave, false, $readonly_lang, 'text');
										BackendHelper::form_input('d2u_machinery_construction_equipment_description_technical', 'form[lang]['. $rex_clang->getId() .'][description_technical]', $machine_lang->description_technical, false, $readonly_lang, 'text');
										BackendHelper::form_textarea('d2u_machinery_construction_equipment_delivery_set_basic', 'form[lang]['. $rex_clang->getId() .'][delivery_set_basic]', $machine_lang->delivery_set_basic, 5, false, $readonly_lang, true);
										BackendHelper::form_textarea('d2u_machinery_construction_equipment_delivery_set_conversion', 'form[lang]['. $rex_clang->getId() .'][delivery_set_conversion]', $machine_lang->delivery_set_conversion, 5, false, $readonly_lang, true);
										BackendHelper::form_textarea('d2u_machinery_construction_equipment_delivery_set_full', 'form[lang]['. $rex_clang->getId() .'][delivery_set_full]', $machine_lang->delivery_set_full, 5, false, $readonly_lang, true);
									}
								?>
							</div>
						</div>
...
if ('' === $func) {
	$query = 'SELECT machine.machine_id, machine.name, category.name AS categoryname, online_status, priority, '
		. '(SELECT MAX(priority) FROM '. \rex::getTablePrefix() .'d2u_machinery_machines) AS max_priority '
	...
	$list->setColumnFormat('priority', 'custom', static function ($params) {
		...
		return BackendHelper::getPriorityButtons(
			(int) $listParams->getValue('machine_id'),
	...
	if (\rex::getUser() instanceof rex_user && (\rex::getUser()->isAdmin() || \rex::getUser()->hasPerm('d2u_machinery[edit_data]'))) {
		$list->addColumn(rex_i18n::msg('status_online'), '<a class="rex-###online_status###" href="' . BackendHelper::getCurrentBackendPage(['func' => 'changestatus', 'entry_id' => '###machine_id###'], [], true) . '"><i class="rex-icon rex-icon-###online_status###"></i> ###online_status###</a>');
		...
		$list->setColumnParams(rex_i18n::msg('delete_module'), ['func' => 'delete', 'entry_id' => '###machine_id###'] + $csrfToken->getUrlParams());
	...
	$list->setColumnFormat(rex_i18n::msg('d2u_helper_open_frontend'), 'custom', static function ($params) {
		...
		return BackendHelper::getFrontendLinkButton((new \TobiasKrais\D2UMachinery\Machine((int) $listParams->getValue('machine_id'), (int) rex_config::get('d2u_helper', 'default_lang')))->getUrl());
	});
