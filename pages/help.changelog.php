...
<p>1.7.6-DEV:</p>
<ul>
	<li>Bugfix: Nach dem erfolgreichen Löschen eines Datensatzes wird jetzt eine Erfolgsmeldung angezeigt (<code>d2u_helper_deleted</code>). Betrifft alle Backend-Löschungen: Maschinen, Kategorien, Kontakte, Branchen, Zertifikate, Merkmale, Optionen, Serviceoptionen, Ausstattungen/-gruppen, Rührwerke, Einsatzgebiete, Zulieferungen, Stahlbearbeitungs-Stammdaten, Produktionslinien inkl. USPs, Gebrauchtmaschinen und Export-Anbieter. Bisher verschwand der Eintrag kommentarlos.</li>
