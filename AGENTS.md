...
- Namespace für Addon-Klassen: `TobiasKrais\D2UMachinery`
...
- Wenn Module unter `modules/90/*` geändert werden, Changelog in `pages/help.changelog.php` prüfen oder aktualisieren.
